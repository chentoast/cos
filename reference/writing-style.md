<!-- Vendored from the `writing-prose-like-a-human` Claude Code skill so the cloud
routine can use it (it can't load local skills). Full version:
reference/writing-style-full.md -->

# Writing Prose Like a Human

Apply this to every brief and every draft cos writes.
...
For the complete guide with full examples, structural patterns, and the exhaustive vocabulary reference, see [writing-style-full.md](writing-style-full.md).
